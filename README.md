...
We managed to locate and create a token for the comments using /**/ and for the nested ones but we couldnt display them o on the output.


HOW TO RUN:
To run this program you can you can use the make command of the makefile.
